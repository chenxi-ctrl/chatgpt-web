                ...
                用户信息修改
                    ...
                    <div class="col-md-12 col-xl-12">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control dqyhss" name="example-disabled-input dqyhss" placeholder="Disabled..." value="<?php echo $_GET['id'];?>" disabled="">
                            </div>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                              <label class="form-label">绘画剩余次数</label>
                              <input value="<?php echo $huihuacs;?>"  type="text" class="form-control huihuacs" name="example-password-input" placeholder="<?php echo $huihuacs;?>">
                            </div>  
                        ...
                        <div class="mt-5 d-flex align-items-center">
                          ...
                          <div class="ml-auto jcgx">
                            <a href="javascript:void(0)" class="btn btn-primary">点我更新用户套餐信息</a>
                          </div>
                        </div>
                        </div>
...
<br><br>
       ...
       <div class="mb-3">
                              <label class="form-label">自定义用户密码</label>
                              <input value=""  type="text" class="form-control yhmmxg" name="example-password-input" placeholder="填写用户新密码">
                            </div>  
               
               
                    <div class="mt-5 d-flex align-items-center">
                    
                          <div class="ml-auto xgyhmm">
                            <a href="javascript:void(0)" class="btn btn-primary">点我修改用户密码</a>
                          </div>
                        </div>             
</div>
...
$.ajax({
  ...
  success: function(response) {
         ...
         alert(response.nr);
           ...
           $('.jcgx').html('<a href="javascript:void(0)" class="btn btn-primary">点我更新用户套餐信息</a>');
