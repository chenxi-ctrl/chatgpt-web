...
<a href="<?php echo $kaml;?>">点我打开</a>
		...
		<br>	 
				...
				<div class="card">
					...
					<div style="     background: linear-gradient(to right, #03A9F4, #00BCD4);" class="card-header bg-primary text-white">
						<h4 class="card-title">Ai绘画点数 套餐购买</h4>
					</div>
					<div class="card-body">
						<form>
						...
						<p><b>下单后会自动给你账号充值，然后你就可以到网站使用Ai绘画，<span style="color:red;">ChatGPT提问和Ai绘画不通用!</span></b></p>
	    ...
	    echo '<p><b style="color:red;">你通过邀请好友获得剩余的余额：<span class="yaye">'.$ketx.'</span>元</b> 你可以用此余额开通套餐！</p>';
				    ...
				    ?>
							...
							<div class="form-check">		      
								<input  required="" class="form-check-input chatgpttz" type="radio">
